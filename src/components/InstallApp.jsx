      ...
      <section id='install' className='mt-40'>
        <div className='flex flex-col justify-center items-center gap-15 mx-10' >
          ...
          <div className='flex flex-row justify-between items-center gap-5 text-2xl font-bold max-sm:w-full max-md:w-xl w-2xl' >
            ...
            <div key={i} className='flex flex-col cursor-pointer gap-5 items-center justify-center border-4 duration-200 hover:-translate-y-2 hover:-translate-x-2 h-30 lg:w-80 md:w-80 sm:w-80 max-sm:min-w-60 max-sm:p-5 px-10 rounded-2xl shadow-[10px_10px_17px_0px_#d1d1d1]'>
