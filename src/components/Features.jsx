      ...
      <section id='features' className='mt-50 max-sm:mt-30'>
        <div className='flex flex-col gap-20 text-black'>
          ...
          <div className='flex flex-row flex-wrap gap-8 items-center justify-center'>
            {CardsData.map((item) => (
              <div className='flex flex-col cursor-pointer gap-5 items-center justify-center mx-10 border-4 duration-200 hover:-translate-y-2 hover:-translate-x-2 min-h-50 max-w-100 max-sm:p-5 px-10 rounded-2xl shadow-[10px_10px_17px_0px_#d1d1d1]'>
